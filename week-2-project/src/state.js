...
const Ex13 = function () {
    ...
    return (
        <div>
            ...
            <button onClick={() => {
                let id = (idx<default_list.length)? idx+1: idx;
                setIdx(id);
                let midArr = default_list.slice(0, id);
                setItems(midArr);
...
const Ex14 = function ({base_list}) {
    ...
    return (
        <div>
            ...
            <button onClick={() => {
                let id = (idx<base_list.length)? idx+1: idx;
                setIdx(id);
                let midArr = base_list.slice(0, id);
                setItems(midArr);
